...
def test_stage2_keeps_forex_zero_compare_when_note_is_bare_no_change():
    ...
    task = {"task_id": "fx-4-bare-no-change", "indicator_key": "DXY", "category": "forex"}
    extraction = {
        "value": 98.5,
        "current_rate": 98.5,
        "daily_change": 0.0,
...
def test_stage2_preserves_existing_forex_zero_compare_with_entry_evidence():
    ...
    task = {"task_id": "fx-4-existing", "indicator_key": "DXY", "category": "forex"}
    extraction = {
        "value": 98.5,
        "current_rate": 98.5,
        "note": "current quote only",
...
def test_stage2_preserves_existing_120d_zero_compare_with_note_direct_window():
    ...
    task = {"task_id": "fx-4-existing-note-direct-window", "indicator_key": "DXY", "category": "forex"}
    extraction = {
        "value": 98.5,
        "current_rate": 98.5,
        "note": "current quote only",
        ...
        "forex": [
            {
                ...
                "current_rate": 98.5,
                "change_120d": 0.0,
                "metric_basis": "direct_window",
            }
        ],
    }
    task = {"task_id": "fx-4-existing-120d-metric-window", "indicator_key": "DXY", "category": "forex"}
    extraction = {
        "value": 98.5,
        "current_rate": 98.5,
        "note": "current quote only",
        ...
        "forex": [
            {
                ...
                "change_120d_base_date": "2026-02-10",
            }
        ],
    }
    task = {"task_id": "fx-4-existing-120d-field-evidence", "indicator_key": "DXY", "category": "forex"}
    extraction = {
        "value": 98.5,
        "current_rate": 98.5,
        "note": "current quote only",
        ...
        "forex": [
            {
                ...
                "current_rate": 98.5,
                "daily_change": 0.0,
                "source": "direct_daily_series",
            }
        ],
    }
    task = {"task_id": "fx-4-existing-daily-source", "indicator_key": "DXY", "category": "forex"}
    extraction = {
        "value": 98.5,
        "current_rate": 98.5,
        "note": "current quote only",
        ...
        "forex": [
            {
                ...
                "current_rate": 98.5,
                "daily_change": 0.0,
                "daily_change_basis": "trend_history_direct_window",
                "daily_change_base_date": "2026-06-09",
            }
        ],
    }
    task = {"task_id": "fx-4-existing-daily-field-evidence", "indicator_key": "DXY", "category": "forex"}
    extraction = {
        "value": 98.5,
        "current_rate": 98.5,
        "note": "current quote only",
...
def test_stage2_rejects_provider_only_daily_change_field_evidence():
    ...
    task = {"task_id": "fx-4-provider-only-daily", "indicator_key": "DXY", "category": "forex"}
    extraction = {
        "value": 98.5,
        "current_rate": 98.5,
        "note": "current quote only",
...
def test_stage2_rejects_daily_change_rate_as_120d_field_evidence():
    ...
    task = {"task_id": "fx-4-daily-rate-120d", "indicator_key": "DXY", "category": "forex"}
    extraction = {
        "value": 98.5,
        "current_rate": 98.5,
        "note": "current quote only",
...
def test_stage2_preserves_120d_zero_when_daily_missing_reason_is_unrelated():
    ...
    task = {"task_id": "fx-4-unrelated-daily-missing", "indicator_key": "DXY", "category": "forex"}
    extraction = {
        "value": 98.5,
        "current_rate": 98.5,
        "note": "current quote only",
...
def test_stage2_rejects_no_window_forex_compare_evidence_text():
    ...
    task = {"task_id": "fx-6-no-window", "indicator_key": "DXY", "category": "forex"}
    extraction = {
        "value": 98.5,
        "current_rate": 98.5,
        "change_120d": 0.0,
...
def test_stage2_rejects_bare_no_window_forex_compare_evidence_text():
    ...
    task = {"task_id": "fx-6-bare-no-window", "indicator_key": "DXY", "category": "forex"}
    extraction = {
        "value": 98.5,
        "current_rate": 98.5,
        "change_120d": 0.0,
...
def test_stage2_rejects_machine_no_value_forex_compare_evidence_text():
    ...
    task = {"task_id": "fx-6-no-value", "indicator_key": "DXY", "category": "forex"}
    extraction = {
        "value": 98.5,
        "current_rate": 98.5,
        "change_120d": 0.0,
        "manual_reason": "missing_120d_window",
        "note": "deepseek_no_value",
        "source_url": "https://www.investing.com/indices/us-dollar-index",
    }
...
def test_stage2_rejects_no_deepseek_key_forex_compare_evidence_text():
    ...
    task = {"task_id": "fx-6-no-deepseek-key", "indicator_key": "DXY", "category": "forex"}
    extraction = {
        "value": 98.5,
        "current_rate": 98.5,
        "change_120d": 0.0,
        "note": "no_deepseek_key 120d",
        "source_url": "https://www.investing.com/indices/us-dollar-index",
    }
...
def test_stage2_rejects_bare_chinese_unavailable_forex_compare_evidence_text():
    ...
    task = {"task_id": "fx-6-bare-cn-unavailable", "indicator_key": "DXY", "category": "forex"}
    extraction = {
        "value": 98.5,
        "current_rate": 98.5,
        "change_120d": 0.0,
...
def test_stage2_rejects_spaced_chinese_negative_forex_compare_evidence_text():
    ...
    task = {"task_id": "fx-6-cn-negative", "indicator_key": "DXY", "category": "forex"}
    extraction = {
        "value": 98.5,
        "current_rate": 98.5,
        "change_120d": 0.0,
